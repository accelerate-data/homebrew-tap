class AdMigration < Formula
  ...
  desc "CLI tool for migrating warehouse stored procedures to dbt models"
  homepage "https://acceleratedata.ai"
  url "https://github.com/accelerate-data/ad-migration/archive/refs/tags/v0.1.0.tar.gz"
  ...
  resource "referencing" do
    ...
    sha256 "25b42124a6c8b632a425174f24087783efbe512a7ee9f4eddf75706f2a173063"
  end
  ...
  resource "rpds-py" do
    url "https://files.pythonhosted.org/packages/source/r/rpds-py/rpds_py-0.22.3.tar.gz"
    sha256 "e32fee8ab45d3c2db6da19a5323bc3362237c8b653c70194414b892fd06a080d"
  end

  resource "sqlglot" do
    url "https://files.pythonhosted.org/packages/source/s/sqlglot/sqlglot-25.34.1.tar.gz"
    sha256 "c8e8bf0baa40a42e0eba6cb5b97de8fed1a9aaa9f5b18ac46a4d4dace51c7a2b"
  end

  resource "typer" do
    url "https://files.pythonhosted.org/packages/source/t/typer/typer-0.15.3.tar.gz"
    sha256 "6e3a7cbf38b0d70a764d20b7e9a43f3e60a0de1bcbc03b94e4a71e0e1fe2bcbf"
  end

  resource "typing-extensions" do
    url "https://files.pythonhosted.org/packages/source/t/typing-extensions/typing_extensions-4.13.2.tar.gz"
